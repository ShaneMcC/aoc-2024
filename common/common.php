...
$bow           '//\\\' $reset
$bow           //  \\\ $name     Advent of Code 2024 $reset
...
$tree      /$led2'$tree..$led1'$tree$led4'$tree..$led2'$tree.$led1'$tree.$led2'$tree.\ $name Advent of Code 2024 $reset
...
$suit        |     |     | $reset
$suit        ({$boots}.-.{$suit} / \\ {$boots}.-.{$suit}) $name Advent of Code 2024 $reset
...
$box    |{$bow}      ||||{$box}      | $reset
$box    |{$bow}      ||||{$box}      | $reset
$box    |{$bow}      ||||{$box}      |$name Advent of Code 2024 $reset
...
$snow   ---.---\\ $buttons  o $snow  /-----.---  $reset
$snow           '-----'`   $name Advent of Code 2024 $reset
